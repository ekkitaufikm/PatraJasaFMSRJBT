    ...
    <section class="job-details-area section--padding">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <form action="{{ url('pengajuan_lembur') }}" method="POST">
                        @csrf     
                        <div class="form-box">
                            ...
                            <div class="form-content contact-form-action row">
                                ...
                                <div class="col-lg-6 responsive-column">
                                    <div class="input-box">
                                        <label class="label-text">Tempat Pengajuan</label>
                                        <div class="form-group">
                                            <span class="la la-pen form-icon"></span>
                                            <input class="date-range form-control" type="text" name="surat_tempat">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 responsive-column">
                                    <div class="input-box">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="date-range form-control" type="date" name="waktu_tanggal">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 responsive-column">
                                    <div class="input-box">
                                        <label class="label-text">Mulai Dari</label>
                                        <div class="form-group">
                                            <span class="la la-clock form-icon"></span>
                                            <input class="date-range form-control" type="time" name="waktu_dari">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 responsive-column">
                                    <div class="input-box">
                                        <label class="label-text">Selesai Pukul</label>
                                        <div class="form-group">
                                            <span class="la la-clock form-icon"></span>
                                            <input class="date-range form-control" type="time" name="waktu_sampai">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 responsive-column">
                                    <div class="input-box">
                                        <label class="label-text">Pekerjaan yang Dilemburkan</label>
                                        <div class="form-group">
                                            <span class="la la-pen form-icon"></span>
                                            <input class="date-range form-control" type="text" name="namaPekerjaan" placeholder="Pekerjaan yang Dilemburkan">
                                        </div>
                                    </div>
                                </div>
                            </div>
