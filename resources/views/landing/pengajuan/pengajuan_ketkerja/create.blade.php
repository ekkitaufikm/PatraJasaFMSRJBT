    ...
    <section class="job-details-area section--padding">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <form action="{{ url('pengajuan_ketkerja') }}" method="POST">
                        @csrf     
                        <div class="form-box">
                            ...
                            <div class="form-content contact-form-action row">
                                ...
                                <div class="col-lg-6 responsive-column">
                                    <div class="input-box">
                                        <label class="label-text">Tanggal Bergabung di Perusahaan</label>
                                        <div class="form-group">
                                            <span class="la la-calendar form-icon"></span>
                                            <input class="date-range form-control" type="date" name="tanggal_gabung">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 responsive-column">
                                    <div class="input-box">
                                        <label class="label-text">Tempat Pengajuan Surat</label>
                                        <div class="form-group">
                                            <span class="la la-pen form-icon"></span>
                                            <input class="date-range form-control" type="text" name="surat_tempat" placeholder="Tempat Pengajuan">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 responsive-column">
                                    <div class="input-box">
                                        <label class="label-text">Tanggal Pengajuan Surat</label>
                                        <div class="form-group">
                                            <span class="la la-calendar form-icon"></span>
