                    ...
                    <div class="card">
                        ...
                        <div class="card-body py-4">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                ...
                                <!--begin::Table body-->
                                <tbody>
                                    @foreach ($pengajuan_ketkerja as $p)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($p->status == 1)
                                                <a href="{{ url('admin/pengajuan_ketkerja') }}/{{ $p->idPKetkerja }}/edit" class="btn btn-primary" title="Detail">Verifikasi</a>
                                                <a href="{{ url("$url/" . $p->idPKetkerja, []) }}" class="btn btn-primary" title="Detail">Detail</a>
                                                @elseif ($p->status == 2)
                                                <a href="{{ url('admin/pengajuan_ketkerja') }}/{{ $p->idPKetkerja }}/edit" class="btn btn-primary" title="Revisi">Revisi</a>
                                                @elseif ($p->status == 3)
                                                <a href="{{ url("$url/" . $p->idPKetkerja, []) }}" class="btn btn-primary" title="Detail">Detail</a>
                                                @endif
                                            </td>
