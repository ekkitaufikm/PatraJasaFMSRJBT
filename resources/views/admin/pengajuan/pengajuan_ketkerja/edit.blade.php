                ...
                <div class="container-xxl">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body py-4">
                            <form action="{{ url('admin/pengajuan_ketkerja') }}/{{ $pengajuan_ketkerja->idPKetkerja }}" method="POST">
                                ...
                                <div class="card-body">
                                    @if ($pengajuan_ketkerja->status == 1)
                                        <div class="mb-3">
                                    ...
                                    @elseif ($pengajuan_ketkerja->status == 2)
                                        <input type="hidden" id="i-nama" class="form-control" name="idPKetkerja" value="{{ $pengajuan_ketkerja->idPKetkerja }}">
                                        <div class="mb-3">
                                            <label class="col-form-label pt-0">Nama Lengkap</label>
                                            <input name="nama" class="form-control" type="text" value="{{ $pengajuan_ketkerja->nama }}">
                                            {{-- penempatan name selalu sebelah input ya, biar gampang di cek --}}
                                        </div>
                                        <div class="mb-3">
                                            <label class="col-form-label pt-0">Nopeg</label>
                                            <input name="nip" class="form-control" type="text" value="{{ $pengajuan_ketkerja->nip }}">
                                            {{-- penempatan name selalu sebelah input ya, biar gampang di cek --}}
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label class="col-form-label pt-0">Tanggal Bergabung di Perusahaan</label>
                                            <input name="tanggal_gabung" class="form-control" type="text" value="{{ $pengajuan_ketkerja->tanggal_gabung }}">
                                            {{-- penempatan name selalu sebelah input ya, biar gampang di cek --}}
                                        </div>
                                        <div class="mb-3">
                                            <label class="col-form-label pt-0">Tempat Pengajuan</label>
                                            <input name="surat_tempat" class="form-control" type="text" value="{{ $pengajuan_ketkerja->surat_tempat }}">
                                            {{-- penempatan name selalu sebelah input ya, biar gampang di cek --}}
                                        </div>
                                        <div class="mb-3">
                                            <label class="col-form-label pt-0">Tanggal Pengajuan</label>
                                            <input name="waktu_tanggal" class="form-control" type="text" value="{{ $pengajuan_ketkerja->waktu_tanggal }}">
                                            {{-- penempatan name selalu sebelah input ya, biar gampang di cek --}}
                                        </div>
                                    @endif
