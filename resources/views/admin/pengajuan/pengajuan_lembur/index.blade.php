                                ...
                                <tbody>
                                    @foreach ($pengajuan_lembur as $p)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($p->status == 1)
                                                <a href="{{ url('admin/pengajuan_lembur') }}/{{ $p->idPLembur }}/edit" class="btn btn-primary" title="Detail">Verifikasi</a>
                                                <a href="{{ url("$url/" . $p->idPLembur, []) }}" class="btn btn-primary" title="Detail">Detail</a>
                                                @elseif ($p->status == 2)
                                                <a href="{{ url('admin/pengajuan_lembur') }}/{{ $p->idPLembur }}/edit" class="btn btn-primary" title="Revisi">Revisi</a>
                                                @elseif ($p->status == 3)
                                                <a href="{{ url("$url/" . $p->idPLembur, []) }}" class="btn btn-primary" title="Detail">Detail</a>
                                                @endif
                                            </td>
