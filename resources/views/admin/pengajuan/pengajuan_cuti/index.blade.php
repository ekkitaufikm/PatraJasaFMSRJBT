                                ...
                                <tbody>
                                    @foreach ($cuti as $p)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($p->status == 1)
                                                <a href="{{ url('admin/pengajuan_cuti') }}/{{ $p->idCuti }}/edit" class="btn btn-primary" title="Detail">Verifikasi</a>
                                                <a href="{{ url("$url/" . $p->idCuti, []) }}" class="btn btn-primary" title="Detail">Detail</a>
                                                @elseif ($p->status == 2)
                                                <a href="{{ url('admin/pengajuan_cuti') }}/{{ $p->idCuti }}/edit" class="btn btn-primary" title="Revisi">Revisi</a>
                                                @elseif ($p->status == 3 OR $p->status == 4)
                                                <a href="{{ url("$url/" . $p->idCuti, []) }}" class="btn btn-primary" title="Detail">Detail</a>
                                                @endif
