                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                ...
                                <thead>
                                    ...
                                    <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">Tanggal Cuti</th>
                                ...
                                <tbody>
                                    @foreach ($pengajuan_izin as $p)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($p->status == 1)
                                                <a href="{{ url('admin/pengajuan_izin') }}/{{ $p->idPIzin }}/edit" class="btn btn-primary" title="Detail">Verifikasi</a>
                                                <a href="{{ url("$url/" . $p->idPIzin, []) }}" class="btn btn-primary" title="Detail">Detail</a>
                                                @elseif ($p->status == 2)
                                                <a href="{{ url('admin/pengajuan_izin') }}/{{ $p->idPIzin }}/edit" class="btn btn-primary" title="Revisi">Revisi</a>
                                                @elseif ($p->status == 3)
                                                <a href="{{ url("$url/" . $p->idPIzin, []) }}" class="btn btn-primary" title="Detail">Detail</a>
                                                @endif
