                                ...
                                <tbody>
                                    @foreach ($checklist as $p)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($p->status == 1)
                                                <a href="{{ url('admin/checklist') }}/{{ $p->id }}/edit" class="btn btn-primary" title="Detail">Verifikasi</a>
                                                <a href="{{ url("$url/" . $p->id, []) }}" class="btn btn-primary" title="Detail">Detail</a>
                                                @elseif ($p->status == 2)
                                                <a href="{{ url('admin/checklist') }}/{{ $p->id }}/edit" class="btn btn-primary" title="Revisi">Revisi</a>
                                                @elseif ($p->status == 3)
                                                <a href="{{ url("$url/" . $p->id, []) }}" class="btn btn-primary" title="Detail">Detail</a>
                                                @endif
