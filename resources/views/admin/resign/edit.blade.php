                            ...
                            <form action="{{ url("$url/update")}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="hidden" name="idAgama" value="{{ $users->idAgama }}">
                                        <select id="select-sem" class="form-select select2" name="idAgama" aria-label="Default select example" required>
                                            <option value="">Pilih Agama</option>
                                            @foreach ($agama as $r) 
                                                <option value="{{ $r->idAgama }}" {{ $r->idAgama == $users->idAgama ? 'selected' : '' }}>{{ $r->nama }}</option>
                                            @endforeach
                                        </select >
                                    </div>
                                    <div class="mb-3">
                                        <label class="col-form-label pt-0">Jenis Kelamin</label>
                                        <input type="hidden" name="idKelamin" value="{{ $users->idKelamin }}">
                                        <select id="select-sem" class="form-select select2" name="idKelamin" aria-label="Default select example" required>
                                            ...
                                            @foreach ($jenis_kelamin as $r) 
                                                <option value="{{ $r->idKelamin }}" {{ $r->idKelamin == $users->idKelamin ? 'selected' : '' }}>{{ $r->nama }}</option>
                                            @endforeach
                                        </select >
                                    </div>
                                    <div class="mb-3">
                                        <label class="col-form-label pt-0">Jabatan</label>
                                        <input type="hidden" name="idJabatan" value="{{ $users->idJabatan }}">
                                        <select id="select-sem" class="form-select select2" name="idJabatan" aria-label="Default select example" required>
                                            ...
                                            @foreach ($jabatan as $r) 
                                                <option value="{{ $r->idJabatan }}" {{ $r->idJabatan == $users->idJabatan ? 'selected' : '' }}>{{ $r->nama }}</option>
                                            @endforeach
                                        </select >
                                    </div>
                                    <div class="mb-3">
