                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                ...
                                <thead>
                                    ...
                                    <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">Tempat Surat</th>
                                ...
                                <tbody>
                                    @foreach ($memo as $p)
                                        <tr>
                                            ...
                                            <td>{{ $p->created_at }}</td>
                                            <td>{{ $p->no_surat }}</td>
                                            <td>{{ $p->surat_tempat }}</td>
                                            <td>
                                                <a href="{{ url("$url/" . $p->idMemo, []) }}" class="btn btn-primary" title="Detail">Detail</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
