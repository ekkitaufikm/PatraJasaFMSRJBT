...
<html lang="en">
    <head>
		...
		<link href="{{ asset('assets/admin/assets/plugins/custom/leaflet/leaflet.bundle.css') }}" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled aside-fixed aside-default-enabled">
				...
				<div id="kt_aside" class="aside aside-default aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
					...
					<div class="aside-logo flex-column-auto pt-9 pb-5" id="kt_aside_logo">
						...
						<a href="{{ url('admin/dashboard') }}">
							<img alt="Logo" src="{{ asset('assets/admin/assets/media/logos/logo.png') }}" width="80%" class="max-h-50px logo-default" />
							<img alt="Logo" src="{{ asset('assets/admin/assets/media/logos/favicon.png') }}" width="50px" class="max-h-50px logo-minimize" />
						</a>
						<!--end::Logo-->
					</div>
					<!--end::Brand-->
                                ...
                                <div class="menu-fit hover-scroll-y me-lg-n5 pe-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="20px" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer">
                                    ...
                                    <div class="menu-item pt-5">
                                        <div class="menu-content">
                                            <span class="fw-bold text-muted text-uppercase fs-7">Master Data</span>
                                        </div>
                                    </div>
                                        ...
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            <div class="menu-item">
                                                <a class="menu-link" href="{{ url('admin/users') }}">
                                                    ...
                                                    <span class="menu-title">Data Tim Management</span>
                                                </a>
                                            </div>
                                            <div class="menu-item">
                                                <a class="menu-link" href="{{ url('admin/supervisor') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Data Supervisor</span>
                                                </a>
                                            </div>
                                            <div class="menu-item">
                                                <a class="menu-link" href="{{ url('admin/manpower') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Data Man Power</span>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        <span class="menu-link">
                                            ...
                                            <span class="menu-title">Users Lainnya</span>
                                            <span class="menu-arrow"></span>
                                        </span>
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            <div class="menu-item">
                                                <a class="menu-link" href="{{ url('admin/mutasi') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link" href="{{ url('admin/pensiun') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link" href="{{ url('admin/resign') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        <span class="menu-link">
                                            ...
                                            <span class="menu-title">Master Lainnya</span>
                                            <span class="menu-arrow"></span>
                                        </span>
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            <div class="menu-item">
                                                <a class="menu-link" href="{{ url('admin/jabatan') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link" href="{{ url('admin/area') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Master Area</span>
                                                </a>
                                            </div>
                                            <div class="menu-item">
                                                <a class="menu-link" href="{{ url('admin/agama') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Master Agama</span>
                                                </a>
                                            </div>
                                            <div class="menu-item">
                                                <a class="menu-link" href="{{ url('admin/alasan_cuti') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Master Alasan Cuti</span>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    {{-- <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        <span class="menu-link">
                                            ...
                                            <span class="menu-title">Migrasi Data</span>
                                            <span class="menu-arrow"></span>
                                        </span>
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            <div class="menu-item">
                                                <a class="menu-link" href="{{ url('admin/import_karyawan') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Import Data Karyawan</span>
                                                </a>
                                            </div>
                                        </div>
                                    </div> --}}
                                    ...
                                    <div class="menu-item pt-5">
                                        <div class="menu-content">
                                            <span class="fw-bold text-muted text-uppercase fs-7">Laporan Bulanan Supervisor</span>
                                        </div>
                                    </div>
                                    <div class="menu-item menu-accordion">
                                        <a class="menu-link" href="{{ url('admin/rkb') }}">
                                            <span class="menu-icon">
                                            ...
                                            <span class="menu-title">Rencana Kerja Bulanan</span>
                                            <span class="menu-arrow"></span>
                                        </a>
                                    </div>
                                    <div class="menu-item menu-accordion">
                                        <a class="menu-link" href="{{ url('admin/laporan_mingguan') }}">
                                            <span class="menu-icon">
                                                <!--begin::Svg Icon | path: icons/duotune/communication/com011.svg-->
                                                <span class="svg-icon svg-icon-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    ...
                                    <div class="menu-item menu-accordion">
                                        <a class="menu-link" href="{{ url('admin/inventori') }}">
                                            <span class="menu-icon">
                                    ...
                                    <div class="menu-item menu-accordion">
                                        <a class="menu-link" href="{{ url('admin/time_schedule') }}">
                                            <span class="menu-icon">
                                                <!--begin::Svg Icon | path: icons/duotune/finance/fin006.svg-->
                                                <span class="svg-icon svg-icon-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    ...
                                    <div class="menu-item pt-5">
                                        <div class="menu-content">
                                            <span class="fw-bold text-muted text-uppercase fs-7">Checklist</span>
                                        </div>
                                    </div>
                                    <div class="menu-item menu-accordion">
                                        <a class="menu-link" href="{{ url('admin/checklist') }}">
                                            <span class="menu-icon">
                                                <!--begin::Svg Icon | path: icons/duotune/communication/com011.svg-->
                                                <span class="svg-icon svg-icon-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    ...
                                    <div class="menu-item pt-5">
                                        <div class="menu-content">
                                            <span class="fw-bold text-muted text-uppercase fs-7">Administrasi</span>
                                        </div>
                                    </div>
                                    <div class="menu-item menu-accordion">
                                        <a class="menu-link" href="{{ url('admin/memo') }}">
                                            <span class="menu-icon">
                                                <!--begin::Svg Icon | path: icons/duotune/communication/com011.svg-->
                                                <span class="svg-icon svg-icon-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    ...
                                    <div class="menu-item menu-accordion">
                                        <a class="menu-link" href="{{ url('admin/pengajuan_cuti') }}">
                                            <span class="menu-icon">
                                    ...
                                    <div class="menu-item menu-accordion">
                                        <a class="menu-link" href="{{ url('admin/pengajuan_lembur') }}">
                                            <span class="menu-icon">
                                                <!--begin::Svg Icon | path: icons/duotune/finance/fin006.svg-->
                                                <span class="svg-icon svg-icon-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            ...
                                            <span class="menu-title">Surat Izin Lembur</span>
                                            <span class="menu-arrow"></span>
                                        </a>
                                    </div>
                                    <div class="menu-item menu-accordion">
                                        <a class="menu-link" href="{{ url('admin/pengajuan_izin') }}">
                                            <span class="menu-icon">
                                                <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                                                <span class="svg-icon svg-icon-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            ...
                                            <span class="menu-title">Izin Keluar Masuk</span>
                                            <span class="menu-arrow"></span>
                                        </a>
                                    </div>
                                    <div class="menu-item menu-accordion">
                                        <a class="menu-link" href="{{ url('admin/pengajuan_ketkerja') }}">
                                            <span class="menu-icon">
                                                <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                                                <span class="svg-icon svg-icon-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            ...
                                            <span class="menu-title">Surat Keterangan Kerja</span>
                                            <span class="menu-arrow"></span>
                                        </a>
                                    </div>
                                    <div class="menu-item menu-accordion">
                                        <a class="menu-link" href="{{ url('admin/surat_peringatan') }}">
                                            <span class="menu-icon">
                                    ...
                                    <div class="menu-item menu-accordion">
                                        <a class="menu-link" href="{{ url('admin/konseling') }}">
                                            <span class="menu-icon">
                                                <!--begin::Svg Icon | path: icons/duotune/communication/com013.svg-->
                                                <span class="svg-icon svg-icon-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between">
							...
							<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
								...
								<a href="{{ url('admin/dashboard') }}" class="d-lg-none">
									<img alt="Logo" src="{{ asset('assets/admin/assets/media/logos/favicon.png') }}" width="50px" class="mh-40px" />
								</a>
								<!--end::Logo-->
								<!--begin::Aside toggler-->
									...
									<div class="d-flex align-items-center ms-2 ms-lg-3" id="kt_header_user_menu_toggle">
										...
										<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
											...
											<div class="menu-item px-3">
												<div class="menu-content d-flex align-items-center px-3">
													...
													<div class="symbol symbol-50px me-5">
														<img alt="Logo" src="{{ asset('assets/admin/assets/media/avatars/300-1.jpg') }}" />
													</div>
													<!--end::Avatar-->
													<!--begin::Username-->
													<div class="d-flex flex-column">
														<div class="fw-bolder d-flex align-items-center fs-5">{{ session()->get('nama') }}</div>
														<span class="fw-bold text-muted text-hover-primary fs-7">{{ session()->get('jabatan') }}</span>
													</div>
													<!--end::Username-->
												</div>
											</div>
											...
											<div class="menu-item px-5">
												<a href="{{ url('admin/profil') }}" class="menu-link px-5">Profile Saya</a>
											</div>
											<!--end::Menu item-->
                                            <!--begin::Menu separator-->
											<div class="separator my-2"></div>
					...
					<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row flex-stack">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="{{ url('admin/dashboard') }}" target="_blank" class="text-gray-800 text-hover-primary">PT.Patra Jasa</a>
                                <span class="text-muted fw-bold me-1">Facility Management Services Region Jawa Bagian Tengah</span>
							</div>
							<!--end::Copyright-->
						</div>
						<!--end::Container-->
												...
												<div class="mh-300px scroll-y me-n7 pe-7">
													...
													<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
														...
														<div class="d-flex align-items-center">
															...
															<div class="symbol symbol-35px symbol-circle">
																<img alt="Pic" src="assets/admin/assets/media/avatars/300-6.jpg" />
															</div>
															<!--end::Avatar-->
															<!--begin::Details-->
															<div class="ms-5">
													...
													<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
														...
														<div class="d-flex align-items-center">
															<!--begin::Avatar-->
															<div class="symbol symbol-35px symbol-circle">
																<img alt="Pic" src="assets/admin/assets/media/avatars/300-5.jpg" />
															</div>
															<!--end::Avatar-->
															<!--begin::Details-->
															<div class="ms-5">
													...
													<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
														...
														<div class="d-flex align-items-center">
															<!--begin::Avatar-->
															<div class="symbol symbol-35px symbol-circle">
																<img alt="Pic" src="assets/admin/assets/media/avatars/300-25.jpg" />
															</div>
															<!--end::Avatar-->
															<!--begin::Details-->
															<div class="ms-5">
													...
													<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
														...
														<div class="d-flex align-items-center">
															<!--begin::Avatar-->
															<div class="symbol symbol-35px symbol-circle">
																<img alt="Pic" src="assets/admin/assets/media/avatars/300-9.jpg" />
															</div>
															<!--end::Avatar-->
															<!--begin::Details-->
															<div class="ms-5">
													...
													<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
														...
														<div class="d-flex align-items-center">
															<!--begin::Avatar-->
															<div class="symbol symbol-35px symbol-circle">
																<img alt="Pic" src="assets/admin/assets/media/avatars/300-23.jpg" />
															</div>
															<!--end::Avatar-->
															<!--begin::Details-->
															<div class="ms-5">
													...
													<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
														...
														<div class="d-flex align-items-center">
															<!--begin::Avatar-->
															<div class="symbol symbol-35px symbol-circle">
																<img alt="Pic" src="assets/admin/assets/media/avatars/300-12.jpg" />
															</div>
															<!--end::Avatar-->
															<!--begin::Details-->
															<div class="ms-5">
													...
													<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
														...
														<div class="d-flex align-items-center">
															<!--begin::Avatar-->
															<div class="symbol symbol-35px symbol-circle">
																<img alt="Pic" src="assets/admin/assets/media/avatars/300-13.jpg" />
															</div>
															<!--end::Avatar-->
															<!--begin::Details-->
															<div class="ms-5">
													...
													<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
														...
														<div class="d-flex align-items-center">
															<!--begin::Avatar-->
															<div class="symbol symbol-35px symbol-circle">
																<img alt="Pic" src="assets/admin/assets/media/avatars/300-21.jpg" />
															</div>
															<!--end::Avatar-->
															<!--begin::Details-->
															<div class="ms-5">
												...
												<div class="mh-300px scroll-y me-n7 pe-7">
													...
													<div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
														<div class="d-flex align-items-center">
															...
															<div class="symbol symbol-35px">
																<img src="assets/admin/assets/media/svg/files/pdf.svg" alt="icon" />
															</div>
															<!--end::Avatar-->
															<!--begin::Details-->
															<div class="ms-6">
													...
													<div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
														<div class="d-flex align-items-center">
															<!--begin::Avatar-->
															<div class="symbol symbol-35px">
																<img src="assets/admin/assets/media/svg/files/doc.svg" alt="icon" />
															</div>
															<!--end::Avatar-->
															<!--begin::Details-->
															<div class="ms-6">
													...
													<div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
														<div class="d-flex align-items-center">
															<!--begin::Avatar-->
															<div class="symbol symbol-35px">
																<img src="assets/admin/assets/media/svg/files/css.svg" alt="icon" />
															</div>
															<!--end::Avatar-->
															<!--begin::Details-->
															<div class="ms-6">
													...
													<div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
														<div class="d-flex align-items-center">
															<!--begin::Avatar-->
															<div class="symbol symbol-35px">
																<img src="assets/admin/assets/media/svg/files/ai.svg" alt="icon" />
															</div>
															<!--end::Avatar-->
															<!--begin::Details-->
															<div class="ms-6">
													...
													<div class="d-flex flex-stack py-4">
														<div class="d-flex align-items-center">
															<!--begin::Avatar-->
															<div class="symbol symbol-35px">
																<img src="assets/admin/assets/media/svg/files/tif.svg" alt="icon" />
															</div>
															<!--end::Avatar-->
															<!--begin::Details-->
															<div class="ms-6">
									...
									<div data-kt-stepper-element="content">
										...
										<div class="w-100">
											...
											<div class="text-center px-4">
												<img src="assets/admin/assets/media/illustrations/sigma-1/9.png" alt="" class="mww-100 mh-350px" />
											</div>
											<!--end::Illustration-->
										</div>
									</div>
											...
											<div class="d-flex flex-column mb-7 fv-row">
												...
												<div class="position-relative">
													...
													<div class="position-absolute translate-middle-y top-50 end-0 me-5">
														<img src="assets/admin/assets/media/svg/card-logos/visa.svg" alt="" class="h-25px" />
														<img src="assets/admin/assets/media/svg/card-logos/mastercard.svg" alt="" class="h-25px" />
														<img src="assets/admin/assets/media/svg/card-logos/american-express.svg" alt="" class="h-25px" />
													</div>
													<!--end::Card logos-->
												</div>
												<!--end::Input wrapper-->
									...
									<div data-kt-stepper-element="content">
										<div class="w-100 text-center">
											...
											<div class="text-center px-4 py-15">
												<img src="assets/admin/assets/media/illustrations/sigma-1/9.png" alt="" class="mw-100 mh-300px" />
											</div>
											<!--end::Illustration-->
										</div>
									</div>
		...
		<!--end::Modals-->
		<!--begin::Javascript-->
		<script>var hostUrl = "assets/admin/assets/index.html";</script>
		...
		<script src="{{ asset('assets/admin/assets/plugins/custom/leaflet/leaflet.bundle.js') }}"></script>
		<script src="{{ asset('assets/admin/assets/plugins/custom/datatables/datatables.bundle.js') }}"></script>
		<!--end::Page Vendors Javascript-->
		<!--begin::Page Custom Javascript(used by this page)-->
		<script src="{{ asset('assets/admin/assets/js/custom/apps/user-management/users/list/table.js') }}"></script>
		<script src="{{ asset('assets/admin/assets/js/custom/apps/user-management/users/list/export-users.js') }}"></script>
		<script src="{{ asset('assets/admin/assets/js/custom/apps/user-management/users/list/add.js') }}"></script>
		...
		<script src="{{ asset('assets/admin/assets/js/custom/intro.js') }}"></script>
		<script src="{{ asset('assets/admin/assets/js/custom/utilities/modals/upgrade-plan.js') }}"></script>
		<script src="{{ asset('assets/admin/assets/js/custom/utilities/modals/create-project/type.js') }}"></script>
		<script src="{{ asset('assets/admin/assets/js/custom/utilities/modals/create-project/budget.js') }}"></script>
		<script src="{{ asset('assets/admin/assets/js/custom/utilities/modals/create-project/settings.js') }}"></script>
		<script src="{{ asset('assets/admin/assets/js/custom/utilities/modals/create-project/team.js') }}"></script>
		<script src="{{ asset('assets/admin/assets/js/custom/utilities/modals/create-project/targets.js') }}"></script>
		<script src="{{ asset('assets/admin/assets/js/custom/utilities/modals/create-project/files.js') }}"></script>
		<script src="{{ asset('assets/admin/assets/js/custom/utilities/modals/create-project/complete.js') }}"></script>
		<script src="{{ asset('assets/admin/assets/js/custom/utilities/modals/create-project/main.js') }}"></script>
		<script src="{{ asset('assets/admin/assets/js/custom/utilities/modals/select-location.js') }}"></script>
...
<!-- Mirrored from preview.keenthemes.com/craft/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 May 2022 04:02:12 GMT -->
</html>