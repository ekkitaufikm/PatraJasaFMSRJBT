                    ...
                    <div class="card">
                        ...
                        <div class="card-body py-4">
                            <form action="{{ url("$url/update")}}" method="POST">
                                ...
                                <div class="card-body">
                                    <input type="hidden" id="i-nama" class="form-control" name="idMCuti" value="{{ $alasan_cuti->idMCuti }}">
                                    <div class="mb-3">
                                        <label class="col-form-label pt-0">Alasan Cuti</label>
                                        <input name="pertanyaan" class="form-control" type="text" value="{{ $alasan_cuti->pertanyaan }}">
