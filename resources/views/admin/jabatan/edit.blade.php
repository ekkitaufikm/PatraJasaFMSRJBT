                    ...
                    <div class="card">
                        ...
                        <div class="card-body py-4">
                            <form action="{{ url("$url/update")}}" method="POST">
                                ...
                                <div class="card-body">
                                    <input type="hidden" id="i-nama" class="form-control" name="idJabatan" value="{{ $jabatan->idJabatan }}">
                                    <div class="mb-3">
                                        <label class="col-form-label pt-0">Jabatan</label>
                                        <input name="nama" class="form-control" type="text" value="{{ $jabatan->nama }}">
                                        {{-- penempatan name selalu sebelah input ya, biar gampang di cek --}}
                                    </div>
                                    <div class="mb-3">
                                        <label class="col-form-label pt-0">Gaji</label>
                                        <input name="gaji" class="form-control" type="text" value="{{ $jabatan->gaji }}">
                                        {{-- penempatan name selalu sebelah input ya, biar gampang di cek --}}
                                    </div>
                                </div>
