                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                    ...
                                    <button type="button" class="btn btn-primary">
                                        <a href="{{ url('admin/surat_peringatan') }}/create">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                ...
                                <thead>
                                    ...
                                    <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                        <th>No</th>
                                        <th class="min-w-125px">Tanggal Surat Peringatan</th>
                                        <th class="min-w-125px">Nama Pegawai</th>
                                        <th class="min-w-125px">Nopeg Pegawai</th>
                                ...
                                <tbody>
                                    @foreach ($surat_peringatan as $p)
                                        <tr>
                                            ...
                                            <td>{{ $p->nip }}</td>
                                            <td>
                                                <a href="{{ url("$url/" . $p->idSPeringatan, []) }}" class="btn btn-primary" title="Detail">Detail</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
