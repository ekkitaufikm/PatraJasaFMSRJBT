                ...
                <div class="container-xxl">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body py-4">
                            <form action="{{ url('supervisor/rkb') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" name="rkb" type="file" accept=".csv, .xls, .xlsx, .pdf">
