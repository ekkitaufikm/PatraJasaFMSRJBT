                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                    ...
                                    <button type="button" class="btn btn-primary">
                                        <a href="{{ url('supervisor/manpower') }}/create">
                                    ...
                                    @foreach ($users as $p)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @elseif ($p->status == 2)
                                                <span class="badge badge-light-info me-auto">Mutasi</span>
                                                @elseif ($p->status == 3)
                                                <span class="badge badge-light-primary me-auto">Pensiun</span>
                                                @elseif ($p->status == 4)
                                                <span class="badge badge-light-danger me-auto">Resign</span>
                                                @endif
                                            </td>
                                            <td>
                                                <a href="{{ url("$url/" . $p->idUsers, []) }}/edit" class="btn btn-primary" title="Ubah Data">Edit</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
