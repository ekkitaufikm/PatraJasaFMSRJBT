                            ...
                            <form action="{{ url("$url/update")}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="idAgama" class="form-control" type="text" disabled value="{{ $users->agama->nama }}">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="idKelamin" class="form-control" type="text" disabled value="{{ $users->kelamin->nama }}">
                                    </div>
                                    <div class="mb-3">
                                        <label class="col-form-label pt-0">Jabatan</label>
                                        <input name="idJabatan" class="form-control" type="text" disabled value="{{ $users->jabatan->nama }}">
                                    </div>
                                    <div class="mb-3">
