                ...
                <div class="container-xxl">
                    ...
                    <div class="card">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                    ...
                                    <button type="button" class="btn btn-primary">
                                        <a href="{{ url('supervisor/time_schedule') }}">
                        ...
                        <div class="card-body py-4">
                            <form action="{{ url('supervisor/time_schedule') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        <label class="col-form-label pt-0">File Rencana Kerja Bulanan</label>
                                        <input class="form-control" name="time_schedule" type="file" accept=".csv, .xls, .xlsx, .pdf">
