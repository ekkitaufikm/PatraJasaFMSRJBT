                ...
                <div class="container-xxl">
                    ...
                    <div class="card">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                    ...
                                    <button type="button" class="btn btn-primary">
                                        <a href="{{ url('supervisor/inventori') }}">
                        ...
                        <div class="card-body py-4">
                            <form action="{{ url('supervisor/inventori') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" name="inventori" type="file" accept=".csv, .xls, .xlsx, .pdf">
