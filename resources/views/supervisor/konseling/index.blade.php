                ...
                <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                    ...
                    <ul class="breadcrumb fw-bold fs-base my-1">
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ url('supervisor/profil') }}" class="text-muted text-hover-primary">Home</a>
                        </li>
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                    ...
                                    <button type="button" class="btn btn-primary">
                                        <a href="{{ url('supervisor/konseling') }}/create">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                ...
                                <thead>
                                    ...
                                    <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                        <th>No</th>
                                        <th class="min-w-125px">Tanggal Konseling</th>
                                        <th class="min-w-125px">Nama Konselor</th>
                                        <th class="min-w-125px">Nama yang Dikonseling</th>
                                ...
                                <tbody>
                                    @foreach ($konseling as $p)
                                        <tr>
                                            ...
                                            <td>{{ $p->created_at }}</td>
                                            <td>{{ $p->nama_konselor }}</td>
                                            <td>{{ $p->nama_pegawai }}</td>
                                            <td>
                                                <a href="{{ url("$url/" . $p->idKonseling, []) }}" class="btn btn-primary" title="Detail">Detail</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
