...
{
     // Untuk panggil view
     private $views      = 'admin/resign';
    
     // Untuk keperluan redirect, hubungannya route / file web
     private $url        = 'admin/resign';
     
     // Title head
     private $title      = 'Halaman Data Karyawan Resign';
     ...
     public function index()
     {
         ...
         $users = $this->mUsers->where('status', 4)->get();
 
         $data = [
             'title'         => $this->title,
             'url'           => $this->url,
             'page'          => 'Data Karyawan Resign',
             'users'          => $users,
         ];
    ...
    public function update(Request $request)
    {
        if (isset($request->photo)) {
            ...
            return redirect("$this->url")->with('sukses', 'Data Resign berhasil di edit');
